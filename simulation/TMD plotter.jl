"""
Plots a TMD system using a set of ordinary differential equations. 
Paramters can be adjusted by sliders in the Makie window generated by the plot to test different possible states of the system.
"""
using GLMakie
using Makie
